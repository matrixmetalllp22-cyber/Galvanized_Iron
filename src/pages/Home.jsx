...
//       {/* About Section */}
//      <section className="py-20 bg-linear-to-br from-gray-100 via-gray-200 to-gray-100 dark:from-slate-900 dark:via-slate-400 dark:to-white-900 relative overflow-hidden transition-colors duration-300">
...
//           Engineering Tomorrow's <span className="text-transparent bg-clip-text bg-linear-to-r from-orange-500 to-orange-700">Solutions</span>
//         </h2>
