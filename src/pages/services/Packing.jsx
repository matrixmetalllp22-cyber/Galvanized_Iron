          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              <div className="rounded-2xl shadow-2xl overflow-hidden bg-neutral-900 border border-white/10">
                <div className="p-8 md:p-12">
                  <div className="rounded-lg bg-neutral-950 p-6 border border-white/10">

                    <img
                      src="/public/images/Horizontal-Flow-Packing-Machine.webp"
                      alt="Packing Machine"
                      className="w-full h-48 md:h-60 object-cover rounded-lg"
                    />

                    <div className="mt-4">
                      <div className="text-sm text-slate-400">Handled with care</div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
            {features.map((feature, i) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ delay: i * 0.08 }}
                className="bg-neutral-900 rounded-2xl p-6 border border-white/10 hover:border-orange-500 hover:shadow-2xl transition transform hover:-translate-y-1"
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-md bg-black grid place-items-center border border-white/10">
                    {feature.icon}
                  </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {specs.map((spec, i) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ delay: i * 0.1 }}
                className="bg-neutral-900 border border-white/10 p-8 rounded-2xl hover:border-orange-500 transition"
              >
      ...
      <section className="py-24 bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 text-white text-center">
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
              className="bg-white text-orange-700 px-8 py-3 rounded-lg font-semibold hover:scale-105 transition"
            >
              Contact Sales
            </a>
