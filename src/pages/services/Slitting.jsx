...
export default function SlittingIndustrial() {
  ...
  return (
    <div className="bg-gradient-to-b from-black via-neutral-950 to-black min-h-screen text-slate-200">
      ...
      <section className="relative overflow-hidden bg-black text-white">
        ...
        <div className="relative container mx-auto px-6 py-36 text-center">
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-slate-300 max-w-4xl mx-auto mb-10"
          >
            Engineered for stainless steel, aluminium, GI/GP & high-strength alloys<br />
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a href="/contact" className="bg-orange-600 hover:bg-orange-700 px-10 py-4 rounded-xl font-bold text-lg shadow-xl transition flex items-center gap-3">
              Request Quote <ArrowRight />
            </a>
            <a href="#specs" className="border-2 border-orange-500 text-orange-400 hover:bg-orange-500/10 px-10 py-4 rounded-xl font-bold text-lg transition">
              View Specifications
            </a>
          </div>
        </div>
      ...
      <section className="py-24 bg-neutral-950">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto mt-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {keyFeatures.map((feat, i) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ delay: i * 0.1 }}
                className="bg-neutral-900 border border-white/10 rounded-2xl p-8 hover:border-orange-500 hover:shadow-2xl transition"
              >
                <div className="text-orange-500 mb-5">{feat.icon}</div>
      ...
      {/* TECH SPECS */}
      <section id="specs" className="py-28 bg-black">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-white">
              Technical <span className="text-orange-500">Capabilities</span>
            </h2>
            <p className="text-xl text-orange-300 mt-4">4HI High-Speed Auto Shimless Line</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl mx-auto">
            {realSpecs.map((spec, i) => (
              <motion.div
                ...
                className="bg-neutral-900 border border-white/10 rounded-xl p-6 text-center hover:border-orange-500 transition"
              >
                <p className="text-3xl font-bold text-orange-400">
                  {spec.value}
                </p>
                <p className="text-sm text-slate-400 mt-3 uppercase tracking-wider">
                  {spec.label}
                </p>
              </motion.div>
            ))}
          ...
          <div className="mt-20 grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className="bg-neutral-900 border border-white/10 rounded-2xl p-8">
                <h3 className="text-2xl font-bold text-orange-400 mb-6 flex items-center gap-3">
                  {box.icon} {box.title}
                </h3>
      ...
      {/* FINAL CTA */}
      <section className="py-28 bg-gradient-to-r from-orange-500 to-amber-600 text-white text-center">
        <h2 className="text-4xl md:text-6xl font-extrabold mb-6">
          Ready for World-Class Slitting?
        </h2>
        ...
        <a
          href="/contact"
          className="bg-white text-orange-600 px-12 py-5 rounded-xl font-bold text-xl shadow-2xl hover:scale-105 transition inline-flex items-center gap-3"
        >
...
// import React from "react";
// import { motion } from "framer-motion";
// import { Layers, Zap, Shield, Package, Ruler, Cog } from "lucide-react";

// export default function SlittingIndustrial() {
//   const features = [
//     { icon: <Layers />, title: "Shimless Tooling", desc: "Fast changeovers with spare slitter head & offline setup." },
//     { icon: <Zap />, title: "High-Speed Automation", desc: "Servo tension control & digital synchronization." },
//     { icon: <Shield />, title: "Surface Protection", desc: "German Laser Polifilm OSL/BSL + interleaving paper." },
//     { icon: <Package />, title: "Export Packing", desc: "Eye-to-Wall & Eye-to-Sky packing systems." },
//     { icon: <Ruler />, title: "±0.1 mm Precision", desc: "Micron-level width accuracy." },
//     { icon: <Cog />, title: "Zero-Defect QC", desc: "Real-time monitoring & traceability." },
//   ];
...
//         <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#ff7a1830,transparent_60%)]" />
//         <div className="relative container mx-auto px-8">
//           <h1 className="text-7xl font-black tracking-tight">
//             Precision <span className="text-orange-500">Slitting</span>
//           </h1>
//           <p className="text-xl text-slate-400 mt-6 max-w-3xl">
//             Cinematic-grade slitting lines delivering export-ready coils for global OEMs.
//           </p>
//         </div>
//       </section>

//       {/* Features */}
//       <section className="py-32 container mx-auto px-8 grid md:grid-cols-3 gap-12">
//         {features.map((f, i) => (
//           <motion.div
//             key={i}
//             whileHover={{ scale: 1.03 }}
//             className="bg-neutral-900/70 backdrop-blur rounded-3xl p-10 border border-white/10"
//           >
//             <div className="text-orange-500 mb-6">{f.icon}</div>
//             <h3 className="text-xl font-bold">{f.title}</h3>
//             <p className="text-slate-400 mt-3">{f.desc}</p>
//           </motion.div>
//         ))}
//       </section>
//     </div>
