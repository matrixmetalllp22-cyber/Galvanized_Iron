  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div
          className={`bg-gradient-to-br ${study.color} text-white p-6 sm:p-10`}
        >
          {study.icon}
          <h2 className="text-2xl sm:text-4xl font-black mt-4 sm:mt-6 leading-tight">
            {study.title}
          </h2>
        ...
        {/* Content */}
        <div className="p-5 sm:p-10 space-y-7 text-gray-300">
          {["Problem", "Approach", "Solution", "Result", "Impact"].map(
            (section, index) => (
              <motion.div
                key={section}
            ...
            <div className="flex flex-wrap gap-3">
              {study.tech.map((t, i) => (
                <motion.span
                  ...
                  className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-xs sm:text-sm font-medium"
                >
                  {t}
                </motion.span>
              ))}
          ...
          <div className="flex justify-end pt-5 border-t border-gray-700">
            <button
              onClick={onClose}
              className="px-5 sm:px-6 py-2.5 sm:py-3 bg-gray-700 text-white rounded-xl font-semibold hover:bg-gray-600 transition-colors"
            >
              Close
            </button>
          </div>
...
export default function GICaseStudies() {
  ...
  return (
    <LayoutGroup>
      <section className="py-14 sm:py-24 bg-black min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          {/* Hero */}
          <div className="text-center mb-12 sm:mb-16">
            <div className="flex justify-center items-center gap-3 text-orange-500 mb-3 sm:mb-4">
              <FaTools />
              <span className="tracking-widest uppercase text-xs sm:text-sm font-semibold">
                Medical Innovation
              </span>
            </div>
            <h1 className="text-3xl sm:text-6xl text-white font-black mb-3 sm:mb-4">
              GI Case Studies
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            {caseStudies.map((study) => (
              ...
              >
                <div
                  className={`bg-gradient-to-br ${study.color} p-6 sm:p-8 text-white`}
                >
                  {study.icon}
