...
const products = [
  { title: "Hot Rolled Steel", slug: "hot-rolled", icon: FaIndustry },
  { title: "Cold Rolled Steel", slug: "cold-rolled", icon: FaLayerGroup },
  { title: "Colour Coated Steel", slug: "colour-coated", icon: FaPaintRoller },
  { title: "Galvanized Steel", slug: "galvanized", icon: FaWarehouse },
  { title: "Chequered Steel", slug: "chequered", icon: FaGripLines },
  { title: "HRPO", slug: "hrpo", icon: FaCompressArrowsAlt },
  // { title: "Welded Pipes", slug: "welded-pipes", icon: FaTools }, // ✅ fixed
  { title: "Steel Plates", slug: "steel-plates", icon: FaBorderAll },
];
          ...
          {products.map((product) => {
            ...
            return (
              ...
              >
                ...
                <Icon
                  className="
                    text-4xl sm:text-5xl mb-4 sm:mb-6
                    text-gray-400
                    transition-all duration-300
                    group-hover:text-white
