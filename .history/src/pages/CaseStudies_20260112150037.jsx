  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-black rounded-3xl w-full max-w-md sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl overflow-hidden border border-gray-700"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className={`bg-gradient-to-br ${study.color} text-white p-6 sm:p-8 md:p-10 lg:p-12`}>
          <motion.div
          ...
          >
            ...
            <p className="mt-4 text-base sm:text-lg opacity-90">{study.description}</p>
          </motion.div>
        </div>

        {/* Content */}
        <div className="p-6 sm:p-8 md:p-10 space-y-8 text-gray-300">
          {["Problem", "Approach", "Solution", "Result", "Impact"].map(
            (section, index) => (
              <motion.div
                key={section}
              ...
              >
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2 border-b border-gray-600 pb-1">
                  {section}
                </h3>
          ...
          >
            <h3 className="text-lg sm:text-xl font-bold text-white mb-3 border-b border-gray-600 pb-1">
              Technologies
            </h3>
            <div className="flex flex-wrap gap-3">
              {study.tech.map((t) => (
                <span
                  key={t}
                  className="px-3 sm:px-4 py-1 sm:py-2 bg-gray-800 text-gray-300 rounded-full text-xs sm:text-sm font-medium"
                >
                  {t}
                </span>
              ))}
          ...
          <div className="flex justify-end pt-6 border-t border-gray-700">
            <button
              onClick={onClose}
              className="px-4 sm:px-6 py-2 sm:py-3 bg-orange-600 text-white rounded-xl font-semibold hover:bg-orange-700 transition-colors"
            >
              Close
            </button>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-black min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-black mb-4">
              GI Case Studies
            </h1>
            <p className="text-gray-400 max-w-xl sm:max-w-2xl md:max-w-3xl mx-auto text-base sm:text-lg">
              Transformative solutions in Gastroenterology powered by cutting-edge technology.
            </p>
          </motion.div>
          ...
          >
            {caseStudies.map((study) => (
              ...
              >
                <div className={`bg-gradient-to-br ${study.color} p-6 sm:p-8 text-white`}>
                  {study.icon}
                  <h3 className="text-xl sm:text-2xl font-bold mt-4 leading-tight">
                    {study.title}
                  </h3>
                </div>
