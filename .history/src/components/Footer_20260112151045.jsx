    ...
    <footer className="bg-[#111] text-gray-400">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-16 md:py-24">
        ...
        >
          ...
          {/* Newsletter - Moved to left for better balance */}
          <motion.div 
            className="w-full sm:max-w-[420px]"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* LINKS - Adjusted grid to better fit 5 columns, uncommented relevant sections */}
        <motion.div 
          className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-10 md:gap-16 mt-20 md:mt-28 text-sm sm:text-base"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 1, ease: "easeOut", delay: 0.2 }}
        >
          ...
          <div>
            <p className="mb-4 text-gray-500 tracking-widest text-xs">COMPANY</p>
            <Link to="/about" className="block mb-2 hover:text-white transition-colors duration-300">About Us</Link>
            {/* <Link to="/careers" className="block mb-2 hover:text-white transition-colors duration-300">Careers</Link> */}
            <Link to="/contact" className="block mb-2 hover:text-white transition-colors duration-300">Contact</Link>
          </div>
          ...
          {/* INDUSTRY - Uncommented title */}
          <div>
            <p className="mb-4 text-gray-500 tracking-widest text-xs">INDUSTRY</p>
            <Link to="/industries" className="block mb-2 hover:text-white transition-colors duration-300">Industries</Link>
            {/* <Link to="/services" className="block mb-2 hover:text-white transition-colors duration-300">Services</Link> */}
          </div>

          {/* CLIENTS - Fixed path if it was a typo */}
          <div>
            <p className="mb-4 text-gray-500 tracking-widest text-xs">CLIENTS</p>
            <Link to="/clients" className="block mb-2 hover:text-white transition-colors duration-300">Clients</Link>
          </div>

          {/* MISC - Fixed typo in Certification path */}
          <div>
            <p className="mb-4 text-gray-500 tracking-widest text-xs">MISC</p>
            <Link to="/certification" className="block mb-2 hover:text-white transition-colors duration-300">Certification</Link>
            <Link to="/" className="block mb-2 hover:text-white transition-colors duration-300">Home</Link>
          </div>
